(self["webpackChunkHorasFrontEnd"] = self["webpackChunkHorasFrontEnd"] || []).push([["main"],{
...
const routes = [
    ...
    {
        path: 'menu',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_menu_menu_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./menu/menu.module */ 7056)).then(m => m.MenuPageModule), canActivate: [_guards_into_guard__WEBPACK_IMPORTED_MODULE_0__.IntoGuard]
    },
    {
        path: 'start',
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IntoGuard": () => (/* binding */ IntoGuard)
/* harmony export */ });
...
let IntoGuard = class IntoGuard {
    canActivate(route, state) {
        return false;
    }
};
IntoGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
